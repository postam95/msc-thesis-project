...
public class TakeHerbalsHome : State
{

    // Provides only one instance of this class, thread-safely.
    private static TakeHerbalsHome instance = null;
    ...
    public static TakeHerbalsHome Instance
    {
        get
        {
            lock (padlock)
    ...
    public override void InState(BaseCharacter character)
    {
        ...
        {
            farmer.ChangeState(GoForHerbals.Instance);
        }
